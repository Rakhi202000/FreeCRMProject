...
import com.LiveSafe.qa.util.TestUtil;
...
public class TestBase {
	...
	public TestBase() {
		...
		prop = new Properties();
		try {
			FileInputStream ip = new FileInputStream("C:\\Users\\rmodi\\eclipse-workspace\\LiveSafe-Assignment\\src\\main\\java\\com\\LiveSafe\\qa\\config\\config.properties");
			prop.load(ip);
